...
export const INITIAL_STUDENTS = [
  {
    ...
    session: 'NEET-PHY Midterm - Hall A',
  ...
  },
  {
    ...
    session: 'NEET-CHE Final - Room 302',
  ...
  },
  {
    ...
    session: 'NEET-BOT Lab Exam - Lab 4',
    verificationStatus: 'Verified',
    faceMatchScore: 99.1,
    registrationStatus: 'Active',
    avatar: 'EW',
...
export const MOCK_EXAM_SESSIONS = [
  'NEET-PHY Midterm - Hall A',
  'NEET-CHE Final - Room 302',
  'NEET-BOT Lab Exam - Lab 4',
  'NEET-PHY-P Calculus - Auditorium 1',
  'NEET UG Zoology Mock - Room 105',
  'Unassigned'
];

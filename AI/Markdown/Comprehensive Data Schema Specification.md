...
Difficulty mapping: `difficulty` is an integer enum with values: `1 = Medium`, `2 = Hard`, `3 = Advanced`.
...
{  
  ...
  "difficulty": 2, // enum: 1=Medium, 2=Hard, 3=Advanced
...
* **Indexes:**  
  ...
  * { "subject": 1, "status": 1, "difficulty": 1 } (Compound index for JIT query buffering — `difficulty` stored as integer enum)  
...
{  
  ...
  // Metadata fields used during JIT processing
  "difficulty": 2, // enum: 1=Medium, 2=Hard, 3=Advanced
  "chapter_name": "Thermodynamics",
  "chapter_number": 3
}
